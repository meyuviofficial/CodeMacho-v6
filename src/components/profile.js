...
function Profile({
  ...
  return (
    <div class="flex items-center mt-32 md:mt-28 px-3">
      <div class="relative w-full group max-w-md min-w-0 mx-auto md:mb-6 break-words bg-white border-2 border-red-600 shadow-2xl dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl">
        <div class="pb-6">
          <div class="flex">
